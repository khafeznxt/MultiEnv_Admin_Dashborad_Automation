...
public class BlinkLoginPRODPage extends BasePage {
    public BlinkLoginPRODPage(WebDriver driver) {
        super(driver);
    ...
    public BlinkLoginPRODPage loadBlinkPROD() {
        driver.get(BlinkConfigUtilsProd.getInstance().BaseUrl());
        return this;
    }
