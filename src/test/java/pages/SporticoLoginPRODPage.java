...
import Utls.SporticoConfigUtilsProd;
...
public class SporticoLoginPRODPage extends BasePage {
    public SporticoLoginPRODPage(WebDriver driver) {
        super(driver);
    ...
    public SporticoLoginPRODPage loadSporticoPROD() {
        driver.get(SporticoConfigUtilsProd.getInstance().BaseUrl());
        return this;
    }
